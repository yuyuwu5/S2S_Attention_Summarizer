...
class AbstractiveDataset(Dataset):
	def __init__(self, data, padding=0, max_text_len=280, max_summary_len = 70):
		self.data = data
...
def buildS2SDataset(samples, padding):
	return AbstractiveDataset(samples, padding=padding, max_text_len=280, max_summary_len=70)
